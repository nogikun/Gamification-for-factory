...
import { DUNGEONS, ENEMIES, getAttributeDisplayName } from '../gameData.js';
      ...
      <div className="dungeon-info">
        <div className="dungeon-details">
          ...
          <div className="info-row">
            <span>属性: {getAttributeDisplayName(currentDungeon.attribute)}</span>
            <span>推奨属性: {getAttributeDisplayName(currentDungeon.recommendedAttribute)}</span>
          </div>
